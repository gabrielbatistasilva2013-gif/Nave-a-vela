        ...
        {activeTab === 'home' && (
          <>
            ...
            <section id="inicio" className="w-full min-h-screen flex flex-col items-center justify-center px-6 text-center max-w-5xl mx-auto py-20 relative overflow-hidden">
              ...
              >
                Vivemos em uma época onde a manipulação digital é usada como arma. Esta plataforma fornece as ferramentas necessárias para detectar conteúdos falsos, verificar a autenticidade das informações e proteger a nossa percepção contra a engenharia social na internet.
              </motion.p>
