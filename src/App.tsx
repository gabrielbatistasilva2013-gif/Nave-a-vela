        ...
        {activeTab === 'home' && (
          <>
            ...
            <section id="inicio" className="w-full min-h-screen flex flex-col items-center justify-center px-6 text-center max-w-5xl mx-auto py-20 relative">
              ...
              <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_20%,transparent_100%)] pointer-events-none -z-10"></div>
              ...
              <motion.div 
                ...
                className="text-5xl md:text-7xl lg:text-8xl font-serif text-white leading-tight max-w-4xl tracking-tight relative z-10"
              >
                A luta contra as <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 italic block sm:inline mt-2 sm:mt-0 drop-shadow-[0_0_20px_rgba(239,68,68,0.3)]">Fake News</span>
              </motion.div>
              ...
              <motion.p
                ...
                className="mt-8 text-slate-300 max-w-2xl text-lg md:text-xl leading-relaxed font-light relative z-10 drop-shadow-md"
              >
              ...
              <motion.div 
                ...
                className="flex flex-col sm:flex-row gap-4 items-center justify-center text-[10px] tracking-widest uppercase opacity-80 mt-8 relative z-10"
              >
                <span className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10 shadow-lg">Nave à Vela - 8º Ano</span>
                <span className="text-blue-300">Segurança da Informação e Ética em Dados</span>
              </motion.div>
              ...
              >
                 <a href="#conteudo" className="px-8 py-5 w-full bg-white text-black hover:bg-slate-200 text-xs font-bold uppercase tracking-widest transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-3 rounded-full group shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)]">
                   Descobrir Mais <ArrowDown className="w-5 h-5 group-hover:translate-y-1 group-hover:opacity-100 opacity-70 transition-all" />
                 </a>
              </motion.div>
